...
import com.app.batch.repository.pass.PassStatus;
...
public class ExpirePassesJobConfig {
    ...
    /**
     * JpaCursorItemReader : JpaPagingItemReader 만 지원하다가 Spring 4.3에서 추가 되었다.
    ...
    /**
     * JpaItemWriter : JPA 의 영속성 관리를 위해 EntityManager 를 필수로 설정해줘야 한다.
     */
    @Bean
